...
public class Account extends BaseEntity {
	...
	public static final byte STATUS_NOT_REGIST = 0;// 未注册
	public static final byte STATUS_NORMAL = 1;// 普通
	public static final byte STATUS_FREEZE_ASSET = 2;// 已冻结资金
	public static final byte STATUS_LIMIT_LOGIN = 3;// 已限制登录
