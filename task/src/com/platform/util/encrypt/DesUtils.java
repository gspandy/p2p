 ...
 * Description:des加密算法
 * 
 * @author <a href="mailto:zhouhuajun@ddsoucai.cn">zhouhuajun</a>
 * @since version1.0
 */
public class DesUtils {

    /** 字符串默认键值 */
    private static String strDefaultKey = "ddsoucai2014";
    ...
    public String encrypt(String strIn) throws Exception {
    	if(StringUtil.isNotBlank(strIn)){
    ...
    public static void main(String[] args) {
        try {
            String test = "429006198811242530";
