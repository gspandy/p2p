...
<div class="admin-left-menu">
	...
	<#if modules.indexOf('admincrm')!=-1 ><a href="/admincrm/feedback.html?accountid=${(account.id)!}" <#if PageMenu?? && PageMenu='feedback'>class="menu_selected"</#if>>反馈记录</a><a href="/admincrm/feedbackadd.html?accountid=${(account.id)!}">+</a><br></#if>
